        ...
        <div className="w-full h-full flex gap-5">
          ...
          <form className="w-full h-full flex flex-col justify-evenly items-center">
            <label className="w-[50%] h-[12%] flex flex-col">
              Name
              <input type="email" className="h-full bg-gray-200 rounded-[15px] p-3" placeholder="James"/>
            </label>
            <label className="w-[50%] h-[12%] flex flex-col">
              Last Name
              <input type="email" className="h-full bg-gray-200 rounded-[15px] p-3" placeholder="Colman"/>
            </label>
            <label className="w-[50%] h-[12%] flex flex-col">
              Email
