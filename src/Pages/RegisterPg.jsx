  ...
  return (
    <motion.div initial={{opacity:0.4,y:200}} animate={{opacity:1, y:0,transitionDuration:"0.4s",transition:"ease-in-out"}}  className="w-full h-auto px-[2%] py-[6%] flex justify-center">
      <div className="w-full h-[88vh] p-[2%] bg-gray-200 rounded-[45px] flex flex-col shadow-2xl shadow-gray-500">
          <h1 className="text-[45px] font-bold text-center mb-5">Sign Up to see your account</h1>
        <div className="w-full h-full flex gap-5">
          ...
          <form className="w-full h-full flex flex-col justify-evenly items-center">
            <label className="w-[50%] h-[12%] flex flex-col">
              Name
              <input type="text" className="h-full bg-gray-200 rounded-[15px] p-3" placeholder="James"/>
            </label>
            <label className="w-[50%] h-[12%] flex flex-col">
              Last Name
              <input type="text" className="h-full bg-gray-200 rounded-[15px] p-3" placeholder="Colman"/>
            </label>
            <label className="w-[50%] h-[12%] flex flex-col">
              Email
            ...
            <motion.button  whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} className="bg-def  w-[22%] text-[25px] text-white text-shadow-lg shadow-xl shadow-gray-400 border-gray-400 p-1 rounded-[15px] bg-gray-300">SignUp</motion.button>
            <p>Already have account? <Link to="/login" className="text-def text-shadow-lg">LogIn</Link> Now</p>
        ...
        <div className="w-[50%] h-[90%] bg-[url('public/Img/bluryBg.jpg')] rounded-[25px] shadow-xl shadow-gray-400 p-15">
          <h1 className="text-white text-[80px] font-bold">Create account to shop now</h1>
        </div>
        </div>
      </div>
    </motion.div>
